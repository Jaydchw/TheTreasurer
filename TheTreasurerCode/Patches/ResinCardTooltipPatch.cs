...
public static class ResinCardTooltipPatch
{
    ...
    [
        ...
        "THETREASURER-HEIST",
        "THETREASURER-HOARDER",
        "THETREASURER-MASTERMIND",
        "THETREASURER-PAWN_SHOP",
        "THETREASURER-POSSESSED_ARTIFACT",
        "THETREASURER-POWER_FANTASY",
        "THETREASURER-REPLICA",
        "THETREASURER-REPURPOSE",
        "THETREASURER-RESIN_SHIELD",
        "THETREASURER-SHATTER_STRIKE",
        "THETREASURER-TRADE_UP",
        "THETREASURER-WINDOW_SHOP",
        "THETREASURER-RESIN_EATER",
        "THETREASURER-EXCHANGE"
    ];
